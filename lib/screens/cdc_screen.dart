                                        ...
                                        Row(
                                          children: [
                                            ...
                                            if (document.imageUrls.isNotEmpty || document.localImagePaths.isNotEmpty)
                                              ElevatedButton(
                                                onPressed: () => _showImageDialog(context, document.imageUrls.isNotEmpty ? document.imageUrls : document.localImagePaths, documentCode: document.code),
                                                style: ElevatedButton.styleFrom(
                                                  minimumSize: const Size(40, 36),
                                                padding: const EdgeInsets.symmetric(horizontal: 10),
                                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
                                            ...
                                            if (document.filePath != null || document.fileUrls.isNotEmpty)
                                              ElevatedButton(
                                                onPressed: () {
                                                  ...
                                                  if (allFiles.length == 1) _viewFile(allFiles[0], title: document.title ?? document.type, documentCode: document.code); else _showFileDialog(context, document);
                                                },
                                                style: ElevatedButton.styleFrom(
                                                  minimumSize: const Size(40, 36),
                                                padding: const EdgeInsets.symmetric(horizontal: 10),
  ...
  void _showFileDialog(BuildContext context, Document document) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(width: double.maxFinite, child: ListView.builder(shrinkWrap: true, itemCount: allFiles.length, itemBuilder: (context, index) => ListTile(leading: const Icon(Icons.attach_file), title: Text(allNames[index]), onTap: () { Navigator.pop(context); _viewFile(allFiles[index], title: document.title ?? document.type, documentCode: document.code); }))),
