...
class _OutgoingDocumentsScreenState extends State<OutgoingDocumentsScreen> {
  ...
  void _replaceDocument(Document next) {
    for (var i = 0; i < _allDocuments.length; i++) {
      if (_allDocuments[i].code == next.code) _allDocuments[i] = next;
    }
                                ...
                                children: [
                                  if (doc.flowStage != 'incoming' && doc.incoming) ...[
                                    Container(
                                      ...
                                      child: const Text('Fr. Incoming', style: TextStyle(fontSize: 10, color: Color(0xFFFFB74D), fontWeight: FontWeight.w500)),
                                    ),
