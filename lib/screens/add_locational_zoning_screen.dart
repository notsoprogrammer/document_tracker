...
class _AddLocationalZoningScreenState extends State<AddLocationalZoningScreen> {
  ...
  String _generateCode() {
    ...
    final typeCode = typeMapping[selectedType] ?? 'LOC';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: locationalZoningTypes.map((type) {
                                ...
                                onPressed: (_isUploadingImages || _isPickingFile || _isSaving) ? null : () async {
                                  ...
                                  if (result != null && result.files.isNotEmpty) {
                                      ...
                                      if (filePath != null && filePath.isNotEmpty && fileSize > 0) {
                                        if (_isImage(file.name)) {
                                          ...
                                          if (currentTotalSize + fileSize > 50 * 1024 * 1024) {
                                            SnackbarUtils.showErrorSnackBar(context, '${file.name} would exceed 50MB total limit.');
                                            continue;
                                          }
                                    ...
                                    if (skippedFiles.isNotEmpty) {
                                      SnackbarUtils.showErrorSnackBar(context, 'Files skipped (>50MB): ${skippedFiles.join(', ')}');
                                    }
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text("Processing scan...", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ),
                        ],
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text("Selecting files...", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ),
                        ],
                                ...
                                if (_selectedImagePaths.isNotEmpty) ...[
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text("${_selectedImagePaths.length} image(s)",
                                ...
                                if (_selectedDocumentPaths.isNotEmpty) ...[
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 4),
                                      Text("${_selectedDocumentPaths.length} document(s)",
                                          style: TextStyle(fontSize: 13, color: Colors.grey.shade700)),
                                    ],
                                  ),
                                  const SizedBox(height: 6),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                _totalUploads > 0 ? 'Uploading files to Google Drive...' : 'Saving record...',
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 4),
                                  Text('$_completedUploads uploaded',
                              ...
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 4),
                                  Text('${_totalUploads - _completedUploads} remaining',
