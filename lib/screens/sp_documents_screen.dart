import 'dart:io';
import 'package:com.cpdco.docutracker/screens/add_sp_documents_screen.dart';
...
class SpDocumentsScreen extends StatefulWidget {
  ...
  @override
  State<SpDocumentsScreen> createState() => _SpDocumentsScreenState();
}

class _SpDocumentsScreenState extends State<SpDocumentsScreen> {
  ...
  void _filterDocuments() {
    setState(() {
      _filteredDocuments = widget.documents.where((doc) {
        if (doc.mode != 'SP Documents') return false;
    ...
    return ConnectivityBanner(
      child: Scaffold(
        floatingActionButton: FloatingActionButton(
          onPressed: () async { await Navigator.push(context, MaterialPageRoute(builder: (context) => const AddSpDocumentsScreen())); await _refreshDocuments(); if (widget.onRefresh != null) widget.onRefresh!(); },
          backgroundColor: const Color(0xFF5C6BC0),
          child: const Icon(Icons.add),
        ),
        appBar: AppBar(
          title: const Text("SP Documents"),
          backgroundColor: const Color(0xFF5C6BC0),
          ...
          bottom: PreferredSize(
            ...
            child: DocumentSearchBar(
              ...
              totalCount: widget.documents.where((d) => d.mode == 'SP Documents').length,
            ),
          ),
        ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      const SizedBox(height: 8), FiledInRow(document: document, onEditLocation: () => _showLocationUpdateDialog(index), onEditHolder: () => _showHeldByDialog(index)),
